...
#
# Discovers a project based on changes between the 
# current and provided git branch, then writes a
# message to trigger later auto generation.
#
# `<changes base ref>` will typically be `origin/main`
# as this is where a PR is typically merged into
#
